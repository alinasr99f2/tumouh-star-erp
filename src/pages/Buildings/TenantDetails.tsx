  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        >
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-[#B4CEC5] md:text-base">
              بيانات وتفاصيل المستأجرين الخاصة بالعمائر
            </p>
          </div>
        </div>
        ...
        >
          {/* Decorative Glow */}
          <div className="pointer-events-none absolute -left-16 -top-16 h-40 w-40 rounded-full bg-emerald-300/[0.05] blur-3xl" />

          <div className="relative z-10">
            <h2 className="text-xl font-bold text-white md:text-2xl">
              صفحة تفاصيل المستأجرين
            </h2>

            <p className="mx-auto mt-3 max-w-2xl text-sm leading-7 text-[#B4CEC5] md:text-base">
              هذه الصفحة جاهزة لبناء جدول وتفاصيل المستأجرين.
            </p>
          </div>
